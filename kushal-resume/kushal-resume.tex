...
LinkedIn: \href{https://www.linkedin.com/in/roykushal/}{\custombold{https://www.linkedin.com/in/roykushal	}} \\
\sectionsep
...
\section{Details}
\descript{Date Of Birth : 29.10.1988 }
\descript{Nationalty : Indian }
\descript{Marital Status : Single }
\descript{Languages Spoken : English }
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     EXPERIENCE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
